...
class TestAnsatzeUnit:
    ...
    def test_hardware_efficient_param_count(self):
        from qoro_pyscf.ansatze import hardware_efficient_param_count
    ...
    def test_uccsd_param_count_tuple(self):
        from qoro_pyscf.ansatze import uccsd_param_count
    ...
    def test_excitation_enumeration(self):
        from qoro_pyscf.ansatze import _get_uccsd_excitations
    ...
    def test_hf_circuit_builds(self):
        from qoro_pyscf.ansatze import hartree_fock_circuit
    ...
    def test_hardware_efficient_hf_requires_nelec(self):
        from qoro_pyscf.ansatze import hardware_efficient_ansatz
    ...
    def test_uccsd_builds(self):
        from qoro_pyscf.ansatze import uccsd_ansatz, uccsd_param_count
...
class TestUpCCDUnit:
    ...
    def test_upccd_fewer_than_uccsd(self):
        ...
        from qoro_pyscf.ansatze import uccsd_param_count, upccd_param_count
    ...
    def test_upccd_excitations_are_paired(self):
        ...
        from qoro_pyscf.ansatze import _get_upccd_excitations
    ...
    def test_upccd_builds(self):
        from qoro_pyscf.ansatze import upccd_ansatz, upccd_param_count
...
class TestAdaptUnit:
    ...
    def test_operator_pool_sd(self):
        from qoro_pyscf.adapt import build_operator_pool
    ...
    def test_adapt_builds_circuit(self):
        from qoro_pyscf.adapt import Operator, _build_adapt_circuit
